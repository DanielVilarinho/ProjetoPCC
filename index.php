...
<header>
    ...
    <main>
        <div class="linha">
            ...
            <div class="coluna">
                <img class="img1" src="assets/imagem1.jpg" alt="Forest" style="width:320px">
            </div>
              <div class="coluna">
                <a href="./servicos.php"> <button class="botao">Ver mais</button> </a>
            </div>
        </div>
        <div class="linha">
            <div class="coluna">
                <a href="./produtos.php"> <button class="botao">Ver mais</button> </a>        
            </div>
            <div class="coluna">
                <ul class="topico">
                <li>Perfumaria</li>
                <li>Utensílios de Maquiagens</li>
                <li>Boutique</li>
                </ul>
            </div>
            <div class="coluna">
                <img src="assets/b72074186dfa485e7fc9d7328d64e601.jpg" alt="Forest" style="width:320px">
            </div>
        </div>
        </div>
        <br>
        <div class="sobre">
            <h1 class="tituloSobre">Sobre</h1>
            <p class="textoSobre">Lurdinha Cabeleireira é um espaço completo, especializado em cuidar e realçar a sua autoestima, onde você encontra inspirações e tendências. Em nosso salão oferecemos diversos serviços como Corte de cabelo, Luzes, Alinhamento de fios, Design de Sobrancelhas, Microblading, Micropigmentação labial, Manicure e Pedicure, Makes e muito mais. Aqui, além de cuidar da sua beleza nos preocupamos em te deixar bonita de todas as formas, pensando nisso temos disponível a nossa Boutique com Roupas Femininas e Perfumaria.</p>
        </div>
        <br>
        <div id="googlemaps">        
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3836.0116305429024!2d-48.26340458459926!3d-15.960769031322307!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x935bda40f06e5ea9%3A0x4fcbb73700388d18!2sR.%2011A%2C%2016%2C%20Santo%20Ant%C3%B4nio%20do%20Descoberto%20-%20GO%2C%2072900-000!5e0!3m2!1spt-BR!2sbr!4v1669584424729!5m2!1spt-BR!2sbr" 
