        ...
        <main>
            <section class="servicos">
                ...
                <div class="servbox">
                    ...
                    <p class="textbox">Profissionais com vasta experiência e prontas para encontrar o design adequado para você. Procedimento na cera, na linha, na navalha ou pinça.<br><br>A partir de........R$ 25,00 </p>
                ...
                <div class="servbox">
                    ...
                    <p class="textbox">Uma equipe de peso que faz com delicadeza e  conforme sua preferência manicure, pedicure, fibra de vidro. Colocar um pouquinho mais de texto.<br><br>A partir de........R$ 25,00</p>
                    <a href="./agendar.php"> <button class="btnbox">Agendar um horario</button> </a>
                </div>
                ...
                <div class="servbox">
                    ...
                    <p class="textbox">Cabeleireiras com anos de prática e conhecimento para realização de procedimentos químicos, tratamentos, penteados, coloração, corte e muito mais.<br><br>A partir de........R$ 35,00</p>
                    <a href="./agendar.php"> <button class="btnbox">Agendar um horario</button> </a>
                </div>
                ...
                <div class="servbox">
                    ...
                    <p class="textbox">Desde de maquiagens simples até as mais  sofisticadas, de acordo com as tendências. Colocar um pouquinho mais de texto, para quebrar a linha<br><br>A partir de........R$ 40,00</p>
                    <a href="./agendar.php"> <button class="btnbox">Agendar um horario</button> </a>
                </div>
                </div>
                </div>
